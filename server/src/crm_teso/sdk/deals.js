...
/*							new OCS.CompetitorWindow({
						...
						Ext.MessageBox.alert('Error', 'Уг үйлдлийг хийхэд таны эрх хүрэлцэхгүй шүү дэдэ!', function() {});
				}
			}),
			Ext.create('Ext.Action', {
				iconCls   : 'delete',
			...
			Ext.create('Ext.Action', {
				...
				handler: function(widget, event) {
					if (me.action) {
						...
						Ext.MessageBox.alert('Error', 'Уг үйлдлийг хийхэд таны эрх хүрэлцэхгүй 123!', function() {});
				}
			}),
			Ext.create('Ext.Action', {
				iconCls   : 'delete',
			...
			Ext.create('Ext.Action', {
				...
				handler: function(widget, event) {		
					if (me.action)
						...
						Ext.MessageBox.alert('Error', 'Уг үйлдлийг хийхэд таны эрх хүрэлцэхгүй 123123"!', function() {});
				}
			}),
			Ext.create('Ext.Action', {
				iconCls : 'delete',
