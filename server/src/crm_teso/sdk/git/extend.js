	...
	getEditor: function(name, value) {
		...
		if (name == 'warehouse_id')
		{
			return {
			  ...
			  store: Ext.create('Ext.data.Store', {
  				  model: 'CRM_PREV',
 				  data: [{value: 1, name: ware_text[0]},{value: 2, name: ware_text[1]},{value: 3, name: ware_text[2]},{value: 4, name: ware_text[3]},{value: 5, name: ware_text[4]},{value: 6, name: ware_text[5]},{value: 7, name: ware_text[6]},{value: 8, name: ware_text[7]}]
              }),
			  name: name,
			  queryMode: 'local',
		      displayField: 'name',
		...
		if (name == 'promo_warehouse_id')
		{
			return {
			  xtype: 'combo',
			  store: Ext.create('Ext.data.Store', {
  				  model: 'CRM_ITEM',
 				  data: [{id: '1', value: 'Агуулах'},{id: '2', value: 'Агуулах'},{id: '3', value: 'Агуулах'},{id: '4', value: 'Агуулах'},{id: '5', value: 'Агуулах'},{id: '6', value: 'Агуулах'},{id: '7', value: 'Агуулах'}]
              }),
			  name: name,
			  queryMode: 'local',
		      displayField: 'value',
